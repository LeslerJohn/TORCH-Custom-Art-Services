<x-app-layout>
    <div class="bg-gradient-to-r from-white to-orange-100">
        <div class="w-full bg-gradient-to-r from-white to-orange-100 min-h-screen flex items-center">
            <div class="container mx-auto py-12 lg:py-5 px-4 sm:px-6 lg:px-8 ">
                <div class="flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div class="w-full md:w-1/2 text-center md:text-left ml-0 md:ml-8 lg:ml-12" data-aos="fade-up" data-aos-duration="1000">
                        <h1 class="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight" data-aos="fade-right" data-aos-delay="200">
                            Discover the Timeless World of
                            <span class="text-orange-500">Traditional Art.</span>
                        </h1>
                        <p class="text-lg sm:text-xl text-gray-700 font-bold mt-6" data-aos="fade-left" data-aos-delay="400">
                    ...
                    <div class="w-full md:w-1/2 flex justify-center md:justify-end mt-4 md:mt-0" data-aos="fade-up" data-aos-delay="800">
                        <img src="{{ asset('images/Hero.png') }}" alt="Hero Picture" class="w-full max-w-[500px] lg:max-w-[800px] xl:max-w-[1500px] h-auto object-cover rounded-lg animate-float">
                    </div>
                    <style>
                        /* Floating Animation */
                        @keyframes float {
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 pb-16 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="mb-4 flex justify-between items-center border-b border-gray-200 dark:border-gray-700" data-aos="fade-right" data-aos-delay="200">
            ...
            <div id="default-tab-content" data-aos="fade-left" data-aos-delay="700">
                <!-- Artwork Grid -->
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <button type="button" onclick="openArtworkModal(this)"
                            data-artwork="{{ json_encode([
                                        ...
                                        'artist_image' => $artwork->artist->user->profileImage ? asset('storage/' . $artwork->artist->user->profileImage->path) : asset('images/profile.default.jpg'),
                        ...
                        <div id="popup-modal" class="hidden fixed inset-0 z-50 flex justify-center items-center bg-black/50">
                            <div class="bg-white rounded-lg shadow-lg p-4 md:p-8 w-full max-w-4xl max-h-[90vh] overflow-y-auto relative mx-4">
                                <!-- Close Button -->
                                <button class="absolute top-2 right-2 md:top-10 md:right-5 text-gray-600 hover:text-gray-900" onclick="closeArtworkModal()">
                                ...
                                <div class="flex flex-col md:flex-row gap-4">
                                    ...
                                    <div class="w-full md:w-1/2 relative">
                                        ...
                                        <div id="carousel-items" class="relative h-64 md:h-96 overflow-hidden rounded-lg">
                                            ...
                                            <img src="your-image.jpg" alt="Carousel Image" class="w-full h-full object-cover">
                                        </div>

                                        <!-- Carousel Controls -->
                                        <button type="button" class="absolute top-1/2 left-2 transform -translate-y-1/2 bg-white/30 px-3 py-2 rounded-full" onclick="prevSlide()">
                                        ...
                                        <button type="button" class="absolute top-1/2 right-2 transform -translate-y-1/2 bg-white/30 px-3 py-2 rounded-full" onclick="nextSlide()">
                                            <svg class="w-4 h-4 text-black dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                                    ...
                                    <div class="w-full md:w-1/2">
                                        <div class="flex items-center gap-2 mt-2">
                                            <img id="modal-artist-image" src="" alt="Artist" class="w-8 h-8 md:w-10 md:h-10 rounded-full object-cover border border-white">
                                            <div>
                                                <div class="flex items-center gap-1">
                                                    <p id="modal-artist" class="text-base md:text-lg font-medium flex items-center"></p>
                                                ...
                                                <p id="modal-date" class="text-xs md:text-sm text-gray-400"></p>
                                            </div>
                                        </div>
                                        <h2 id="modal-title" class="text-xl md:text-2xl font-bold mt-4"></h2>
                                        <p id="modal-description" class="text-sm md:text-base text-gray-700 mb-2"></p>
                                        <p id="modal-category" class="text-base md:text-lg text-black-500"></p>
                                        <div class="mt-4">
                                            <h3 class="text-sm md:text-md font-semibold">Tags:</h3>
                                            <div id="modal-tags" class="flex flex-wrap text-xs md:text-sm gap-2 mt-2">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 pb-16 mt-12 overflow-hidden">
            <h1 class="text-4xl font-bold text-center sm:text-left" data-aos="fade-right" data-aos-delay="700">Your Trusted Custom Art Platform</h1>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-16 mt-12">
                <div>
                    <h3 class="text-xl font-bold mb-2 text-gray-600" data-aos="fade-right" data-aos-delay="800">Explore Unique Art Creations</h3>
                    <p data-aos="fade-up-right" data-aos-delay="900">Our mission is to provide a seamless experience for art lovers,
                ...
                <div>
                    <h3 class="text-xl font-bold mb-2 text-gray-600" data-aos="fade-left" data-aos-delay="800">Commission Your Dream Artwork</h3>
                    <p data-aos="fade-up-left" data-aos-delay="900">At Torch, we connect you with talented artists in Zamboanga for custom art
                        commissions and offer a selection of beautiful premade artworks to enhance your space.</p>
                </div>
            </div>
            <img src="{{asset('images/default.image.jpg')}}" alt="" class="w-full h-64 sm:h-96 object-cover rounded-lg mt-12" data-aos="fade-up" data-aos-delay="900">
        </div>
        ...
        <div
            ...
            <h1 class="text-4xl text-orange-500 font-bold" data-aos="fade-right" data-aos-delay="300">Hear from our users</h1>
            ...
            <div class="flex gap-6 mt-8 items-center justify-center">
                ...
                <div class="flex flex-col items-center justify-center bg-white w-80 h-96 rounded-lg p-8 shadow-lg" data-aos="fade-up" data-aos-delay="800">
