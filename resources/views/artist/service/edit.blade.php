            ...
            <div class="flex flex-col md:flex-row gap-16">
                <div class="flex flex-col w-full md:w-[400px]">
                    ...
                    <div class="mt-6">
                        ...
                        <x-text-input id="normal_timeframe" class="block mt-1 w-full" type="number" name="normal_timeframe" required placeholder="No. of days completion." value="{{$service->normal_timeframe}}"/>
                    ...
                    <div class="mt-6">
                        ...
                        <x-text-input id="rush_timeframe" class="block mt-1 w-full" type="number" name="rush_timeframe" required placeholder="No. of days completion." value="{{$service->rush_timeframe}}"/>
