            ...
            <tbody>
                ...
                <tr class="border-b border-gray-200 dark:border-gray-700">
                    ...
                    <button data-modal-target="edit-discount-{{ $discount->id }}" data-modal-toggle="edit-discount-{{ $discount->id }}"
                        class="text-yellow-800 bg-yellow-100 hover:bg-yellow-200 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-full text-xs px-4 py-0.5 text-center dark:bg-yellow-400 dark:hover:bg-yellow-500 dark:focus:ring-yellow-600"
                        type="button">
                        Edit
                    </button>
                    ...
                    <!-- Delete Button -->
                    <button data-modal-target="delete-confirmation-{{ $discount->id }}" data-modal-toggle="delete-confirmation-{{ $discount->id }}"
                        class="text-red-800 bg-red-100 hover:bg-red-200 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-full text-xs px-4 py-1 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-800"
                        type="button">
                        Delete
                    </button>

                    <!-- Delete Confirmation Modal -->
                    <div id="delete-confirmation-{{ $discount->id }}" tabindex="-1" aria-hidden="true"
                        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                            ...
                            <button type="button"
                                class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                data-modal-hide="delete-confirmation-{{ $discount->id }}">
                                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                            ...
                            <div class="p-4 md:p-5">
                            <p class="text-sm text-gray-500 dark:text-gray-300">Are you sure you want to delete this discount?</p>
                            <div class="mt-4 flex justify-end space-x-2">
                                <button type="button" data-modal-hide="delete-confirmation-{{ $discount->id }}"
                                class="text-gray-700 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-300 rounded-lg border border-gray-300 text-sm font-medium px-5 py-2.5 dark:bg-gray-600 dark:text-gray-300 dark:border-gray-500 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                                Cancel
                                </button>
