<x-admin-layout>
    <div>
        <div class="flex gap-4 items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-900">Request ID #123123</h1>
        </div>
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <img src="{{ asset('images/default.image.jpg') }}" alt="img"
                            class="w-full max-h-74 object-cover">
                    </div>
                </div>
    ...
    <div class="flex mt-6 mb-16 gap-4 justify-center items-center">
        <div>
            @include('admin.commission.partials.hold-form')
        </div>
        <div>
            @include('admin.commission.partials.approve-form')
        </div>
        <div>
            @include('admin.commission.partials.deny-form')
        </div>
    </div>
</x-admin-layout>
