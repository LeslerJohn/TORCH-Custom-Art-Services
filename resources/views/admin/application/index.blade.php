<x-admin-layout>
    <div class="relative mt-16 mr-6 p-2 overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                @if($user->artist)
                                    <div class="h-2.5 w-2.5 rounded-full bg-orange-500 me-2"></div> {{ $user->artist->status }}
                                @else
                        ...
                        <td class="px-6 py-4 flex items-center gap-2">
                            <a href="{{route('admin.application.show', $user->id)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
