<x-app-layout>
    <div class="max-w-5xl mt-4 md:mt-10 mx-4 md:mx-auto bg-white p-4 md:p-6 rounded-lg shadow-lg relative">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600 text-sm md:text-base">Shipping to:
        ...
        <!-- Shipping Progress -->
        <div class="mb-6">
            <h2 class="text-lg md:text-xl font-semibold mb-2">Shipping Progress</h2>
        ...
        <div class="mb-6">
            <h2 class="text-lg md:text-xl font-semibold mb-2">Your Order from
        ...
        <div class="mb-6">
            <h2 class="text-lg md:text-xl font-semibold mb-2">Support Center</h2>
            <p class="text-gray-600 text-sm md:text-base">Having issues with your order?
