        ...
        <div class="flex-1 transition-all duration-300 px-4 max-h-[calc(125vh-300px)] overflow-y-auto no-scrollbar"
            ...
            <div x-show="tab === 'collections'" class="mt-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
                        <!-- Display the first artwork's image in the order -->
                        @php
                        $thumbnail = $collection->items->first()->artwork->images->first()?->attachment;
                        @endphp
