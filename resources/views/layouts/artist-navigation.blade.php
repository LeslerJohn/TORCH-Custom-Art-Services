<nav x-data="{ open: false }" class="bg-white border-b-4 border-orange-400 dark:border-orange-700 fixed top-0 left-0 w-full z-100">
        ...
        <div class="hidden sm:flex sm:items-center sm:ms-6">
            ...
            <form method="POST" action="{{ route('artist.availability') }}">
                ...
                <label class="inline-flex items-center cursor-pointer">
                    <span class="ms-3 mr-1 text-sm font-medium text-gray-900 dark:text-gray-300">Available</span>
