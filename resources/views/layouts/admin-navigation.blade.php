<nav x-data="{ open: false }" class="z-10 fixed top-0 left-0 right-0 bg-white dark:bg-gray-800 border-b-4 border-gray-100 dark:border-gray-700">
    ...
    <div class="mx-auto px-4 sm:px-4 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-10 w-auto object-fit" />
                    </a>
                </div>
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link class="text-md font-bold" :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')">
                        {{ __('Admin Dashboard') }}
                    </x-nav-link>

                    {{-- <h2 class="flex items-center text-center font-bold text-[20px]">Artist Dashboard</h2> --}}
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="flex">
                    {{-- <a href="{{ route('admin.notifications') }} " class="inline-flex items-center px-2 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-black bg-black-600 hover:bg-black-500 focus:outline-none focus:border-black-700 focus:shadow-outline-black active:bg-black-700 transition ease-in-out duration-150"> --}}
                        <img src="{{ asset('icons/notification-svgrepo-com.svg') }}" alt="Icon 1" class="fill-current w-5 h-5">
                    {{-- </a> --}}
                </div>
